package com.plataforma.noticias;
...
class NoticiasApplicationTests{
	...
	private Noticias buildFavorito() {
		...
		noticias.setImageUrl("https://spacenews.com/wp-content/uploads/2023/01/kamal_f-300x300.jpg");
		noticias.setNewsSite("SpaceNews");
		...
		//noticias.setPublishedAt("2023-10-02T20:03:44Z").toLocalDateTime();
		//noticias.setUptatedAt("2023-10-02T20:07:49.906000Z");
		noticias.isFeatured();
		return noticias;
	}
}
